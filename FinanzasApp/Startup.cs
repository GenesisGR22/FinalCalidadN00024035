...
namespace FinanzasApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICuenta, CuentaService>();
            services.AddTransient<IGasto, GastosService>();
            services.AddTransient<IIngresos, IngresosService>();
        }
